...
<!-- header -->
		<header>
			...
			<div class="img"><img src="<?php echo base_url()?>images/img.jpg" alt=""></div>
		</header>
<!-- / header -->
<!-- content -->
		<section id="content">
			...
			<article class="col2 pad_left1">
				...
				<div class="wrapper">
					<figure class="left marg_right1"><img src="<?php echo base_url()?>images/page1_img5.jpg" alt=""></figure>
